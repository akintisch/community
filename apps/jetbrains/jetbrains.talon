...
switch project: user.idea("action ActivateProjectToolWindow")
switch find: user.idea("action ActivateFindToolWindow")
switch run: user.idea("action ActivateRunToolWindow")
switch debug: user.idea("action ActivateDebugToolWindow")
switch events: user.idea("action ActivateEventLogToolWindow")
switch terminal: user.idea("action ActivateTerminalToolWindow")
switch term: user.idea("action ActivateTerminalToolWindow")
switch git: user.idea("action ActivateVersionControlToolWindow")
switch structure: user.idea("action ActivateStructureToolWindow")
switch database: user.idea("action ActivateDatabaseToolWindow")
switch data: user.idea("action ActivateDatabaseToolWindow")
switch database changes: user.idea("action ActivateDatabaseChangesToolWindow")
switch make: user.idea("action ActivatemakeToolWindow")
switch to do: user.idea("action ActivateTODOToolWindow")
switch docker: user.idea("action ActivateDockerToolWindow")
switch favorites: user.idea("action ActivateFavoritesToolWindow")
switch last: user.idea("action JumpToLastWindow")
# Pin/dock/float
switch pinned: user.idea("action TogglePinnedMode")
switch docked: user.idea("action ToggleDockMode")
switch floating: user.idea("action ToggleFloatingMode")
switch windowed: user.idea("action ToggleWindowedMode")
switch split: user.idea("action ToggleSideMode")
# Settings, not windows
switch tool buttons: user.idea("action ViewToolButtons")
switch toolbar: user.idea("action ViewToolBar")
switch status [bar]: user.idea("action ViewStatusBar")
switch navigation [bar]: user.idea("action ViewNavigationBar")
